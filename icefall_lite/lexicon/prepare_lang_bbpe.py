...
from icefall_lite.lexicon.prepare_lang import Lexicon, add_disambig_symbols, add_self_loops, write_lexicon, write_mapping
from icefall_lite.utils import byte_encode, str2bool, tokenize_by_CJK_char
...
def generate_lexicon(model_file: str, words: List[str], oov: str) -> Tuple[Lexicon, Dict[str, int]]:
