...
from icefall_lite.lexicon import read_lexicon, write_lexicon
from icefall_lite.lexicon.prepare_lang import add_disambig_symbols, generate_id_map, get_words, lexicon_to_fst, write_mapping
