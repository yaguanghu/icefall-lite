...
class CtcTrainingGraphCompiler(object):
    ...
    def __init__(
        ...
        if need_repeat_flag:
            self.ctc_topo._is_repeat_token_ = (self.ctc_topo.labels != self.ctc_topo.aux_labels)
    ...
    def compile(self, texts: List[str]) -> k2.Fsa:
        ...
        decoding_graph = k2.compose(self.ctc_topo, fsa_with_self_loops, treat_epsilons_specially=False)
    ...
    def convert_transcript_to_fsa(self, texts: List[str]) -> k2.Fsa:
        ...
        fsa = k2.intersect(self.L_inv, word_fsa_with_self_loops, treat_epsilons_specially=False)
