...
from icefall_lite.lm.transformer_lm.encoder import Transformer
from icefall_lite.utils import AttributeDict, add_eos, add_sos, make_pad_mask
...
class TransformerLM(torch.nn.Module):
    ...
    def __init__(
        ...
        self.output_linear = torch.nn.Linear(in_features=d_model, out_features=vocab_size)
        if tie_weights:
