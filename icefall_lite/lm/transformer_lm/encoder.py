...
from icefall_lite.lm.transformer_lm.attention import RelPositionMultiheadAttention
from icefall_lite.utils.scaling import ActivationBalancer, BasicNorm, DoubleSwish, ScaledConv1d, ScaledConv2d, ScaledLinear
from icefall_lite.utils.utils import is_jit_tracing, make_pad_mask
...
class RelPositionalEncoding(torch.nn.Module):
    ...
    def forward(
        ...
        pos_emb = self.pe[
            :,
            self.pe.size(1) // 2 - x_size_1 + 1:self.pe.size(1) // 2    # noqa E203
            + x.size(1),
        ]
