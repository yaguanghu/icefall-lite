...
from icefall_lite.graph.lm_dataset import get_dataloader
from icefall_lite.graph.rnn_lm.model import RnnLmModel
from icefall_lite.utils.checkpoint import load_checkpoint
from icefall_lite.utils.checkpoint import save_checkpoint as save_checkpoint_impl
from icefall_lite.utils.checkpoint import save_checkpoint_with_global_batch_idx
from icefall_lite.utils.dist import cleanup_dist, setup_dist
from icefall_lite.utils.env import get_env_info
from icefall_lite.utils.utils import AttributeDict, MetricsTracker, setup_logger, str2bool
    ...
    for batch_idx, batch in enumerate(train_dl):
        ...
        if batch_idx % params.log_interval == 0:
            ...
            if tb_writer is not None:
                ...
                tb_writer.add_scalar("train/current_ppl", this_batch_ppl, params.batch_idx_train)
        ...
        if batch_idx > 0 and batch_idx % params.valid_interval == 0:
            ...
            if tb_writer is not None:
                ...
                tb_writer.add_scalar("train/valid_ppl", valid_ppl, params.batch_idx_train)
