...
from icefall_lite.bin.train import add_model_arguments, get_params, get_transducer_model
from icefall_lite.utils import (average_checkpoints, average_checkpoints_with_averaged_model, convert_scaled_to_non_scaled,
                                find_checkpoints, load_checkpoint, str2bool)
...
def main():
    ...
    if not params.use_averaged_model:
        if params.iter > 0:
            ...
            if len(filenames) == 0:
                raise ValueError(f"No checkpoints found for"
        ...
        if params.iter > 0:
            ...
            logging.info("Calculating the averaged model over iteration checkpoints"
            ...
            logging.info(f"Calculating the averaged model over epoch range from "
