...
class FlopsProfiler(object):
    ...
    def __init__(self, model, module_hoop_mapping=None):
        ...
        self.module_hoop_mapping = (module_hoop_mapping if module_hoop_mapping is not None else MODULE_HOOK_MAPPING)
        ...
        def register_module_hooks(module, ignore_list):
            ...
            if type(module) in self.module_hoop_mapping:
                if not hasattr(module, "__flops_handle__"):
                    module.__flops_handle__ = module.register_forward_hook(self.module_hoop_mapping[type(module)])
                return
